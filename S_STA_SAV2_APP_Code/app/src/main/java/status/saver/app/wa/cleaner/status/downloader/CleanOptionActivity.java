...
public class CleanOptionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void onTapBtn(String category, String receivePath, String sentPath) {
        if (Utils.iswApp) {
            if (status.saver.app.wa.cleaner.status.downloader.util.Utils.appInstalledOrNot(CleanOptionActivity.this, "com.whatsapp")) {
            ...
            if (status.saver.app.wa.cleaner.status.downloader.util.Utils.appInstalledOrNot(CleanOptionActivity.this, "com.whatsapp.w4b")) {
                onTTap(category, receivePath, sentPath);
            } else {
