package status.saver.app.wa.cleaner.status.downloader.fragments;
...
import status.saver.app.wa.cleaner.status.downloader.adapter.RecWappAdapter;
...
public class RecentWappBus extends Fragment implements RecWappAdapter.OnCheckboxListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recentGrid = (GridView) rootView.findViewById(R.id.recentGrid);
        ...
        sAccessBtn.setOnClickListener(v -> {
            ...
            if (status.saver.app.wa.cleaner.status.downloader.util.Utils.appInstalledOrNot(getActivity(), "com.whatsapp.w4b")) {
...
//            myAdapter.notifyDataSetChanged();
    ...
    class downloadAll extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog = status.saver.app.wa.cleaner.status.downloader.util.Utils.loadingPopup(getActivity());
            alertDialog.show();
        }
            ...
            if (!filesToDelete.isEmpty()) {
                ...
                for (int i = 0; i < filesToDelete.size(); i++) {
                    ...
                    if (fromTreeUri.exists()) {
                        ...
                        if (status.saver.app.wa.cleaner.status.downloader.util.Utils.download(getActivity(), details.getFilePath())) {
